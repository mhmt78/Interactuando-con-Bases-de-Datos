const EnrutadorEvento = require('express').Router();
const Usuario = require('./usuarios.js')
const Evento = require('./eventos.js')
const Operaciones = require('./crud.js')
let ObjectId = require('mongoose').Types.ObjectId;


EnrutadorEvento.get('/all', function(req, res) {
...
EnrutadorEvento.post('/delete/:_id', function(req, res) {
...
EnrutadorEvento.post('/update/:_id&:start&:end', function(req, res) {
  req.session.reload(function(err) {
    if(err){
      console.log(err)
      res.send("logout")
...
module.exports = EnrutadorEvento
